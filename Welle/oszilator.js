...
function dragString(s) {
  let {x_str, y_str} = cnv2strng_coords(20,canvas.height-(eval(wave)+canvas.height/2));
  t++;
...
addEventListener("keydown", (e) => {
  if(e.key=='+'){
    ...
    let potential = prompt("Wave equation",wave);
    try{
      eval(potential);
      wave = potential;
    }catch(e){
    ...
    wave = (adding)?wave+"+sin(t)*200*(t%20)/10":"sin(t)*200*(t%20)/10";
    t = 0;
    s = new String(200)
  }else if(e.key=='2'){
    wave = (adding)?wave+"+sin(t)*200+sin(t*20)*10":"sin(t)*200+sin(t*20)*10";
    t = 0;
    s = new String(200)
  }else if(e.key=='3'){
    wave = (adding)?wave+"+sin(t)*200*Math.pow(2,-t/1000)":"sin(t)*200*Math.pow(2,-t/1000)";
    t = 0;
    s = new String(200)
  }else if(e.key=='4'){
    wave = (adding)?wave+"+sin(t)*200+cos(t/2)*400":"sin(t)*200+cos(t/2)*400";
    t = 0;
    s = new String(200)
  }else if(e.key=='5'){
    wave = (adding)?wave+"+100*(t%50==0)":"100*(t%50==0)";
    t = 0;
    s = new String(200)
  }else if(e.key=='6'){
    wave = (adding)?wave+"+sin(t)*200+400*(t%200<100)-80":"sin(t)*200+400*(t%200<100)-80";
    t = 0;
    s = new String(200)
  }
},
